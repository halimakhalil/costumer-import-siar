...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        Context::initialize(
            env('SHOPIFY_API_KEY', '4a52946294dd27396445802bc71eff87'),
            env('SHOPIFY_API_SECRET', '33aad414ce2154685a92c7bde76c36c7'),
            env('SCOPES', 'read_products,write_products,read_orders,write_orders,read_customers,write_customers'),
            $host,
